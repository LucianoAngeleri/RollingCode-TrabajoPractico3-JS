...
do {
    ...
    if (isNaN(lado1) || isNaN(lado2) || lado1 === "" || lado2 === "" || lado1 === null || lado2 === null || lado1 <= 0 || lado2 <= 0){
...
if (condicion) {
    ...
    document.write('<section class="container">');
    document.write(`<h5 class="display-5 text-center">Resultado de la función para calcular el perímetro de un rectángulo</h5>"`);
    document.write(`<p class="text-center text-success fs-1">El perimetro del rectángulo de lado ${lado1} y ${lado2} es: ${resultado}</p>"`);
    document.write("</section>")
}
